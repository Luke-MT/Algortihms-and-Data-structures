...
static void upo_merge_sort_merge(void *base, size_t low, size_t mid, size_t high, size_t size, upo_sort_comparator_t cmp);
...
void upo_copy(void *a, void *b, size_t n);
...
void upo_copy(void *a, void *b, size_t size){
